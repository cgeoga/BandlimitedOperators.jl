...
function NUFFT3(s1::Vector{Float64}, s2::Vector{Float64}, sgn, tol=1e-15)
  NUFFT3([s1], [s2], sgn, tol)
end

function NUFFT3(s1::Matrix{Float64}, s2::Matrix{Float64}, sgn, tol=1e-15)
...
function NUFFT3(s1::Vector{SVector{S,Float64}}, 
                s2::Vector{SVector{S,Float64}}, sgn, tol=1e-15) where{S}
